...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-20 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[15px] mb-2">
          <img src={discount} alt="discount" className="w-[45px] h-[45px]" />
          <p className={`${styles.paragraph} mx-4`}>
            <span className="text-white">25%</span> Discount For{" "}
            <span className="text-white">7 Weeks</span> Account
          </p>        
        </div>
